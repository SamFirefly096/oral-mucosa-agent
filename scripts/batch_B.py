#!/usr/bin/env python3
"""Parallel batch batch_B: 24 runs (Chief_Original x all 24 cases)"""
...
from agents_enhanced import ChiefMedAgent, OriginalPatientAgent, PatientContext
...
elapsed_total = time.time() - t0_total
print(f'\n{"="*40}\nbatch_B DONE: {ok}/{total} ok, {fail} fail, {elapsed_total/60:.0f}min\n{"="*40}', flush=True)
