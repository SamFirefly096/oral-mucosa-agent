...
(function () {
  ...
  const DICT = {
    ...
    "下一步": "Next",
    "开始使用": "Start",
    "画面右下角的「结束问诊」悬浮按钮": "The floating “End consultation” button at the bottom-right",
    "「结束问诊」是右下角悬浮按钮：问诊全程都在，页面滚到哪儿都能直接点，不必往上翻找。": "End consultation is a floating button at the bottom-right: it stays on screen during the whole consultation, so you never have to scroll up to find it.",
    "问诊充分后点右下角「结束问诊」，系统结束对话并开放诊断评估面板。": "When you have enough information, tap “End consultation” at the bottom-right; the dialogue closes and the diagnosis form opens.",
    "工具箱（问诊进行中）": "Toolbox (during a consultation)",
    "诊断填写面板（结束问诊后弹出）": "Diagnosis form (opens after ending the consultation)",
